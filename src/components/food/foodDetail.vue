    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @on-only-content="OnonlyContent" @on-select-type="OnselectType" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
  ...
  export default {
    ...
    filters: {
      formatDate: function (time) {
        ...
        return formatDate(date, 'yyyy-M-d hh:mm:ss');
      }
    },
    components: {
      cartcontrol,
