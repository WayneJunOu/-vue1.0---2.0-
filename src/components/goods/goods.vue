    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="item in goods" class="food-list food-list-hook">
          ...
          <ul>
            <li @click="goDetails(food,$event)" v-for="food in item.foods" class="food-item border-1px">
              <div class="icon">
...
<script type="text/ecmascript-6">
  ...
  import cartontrol from '../../components/cartcontrol/cartcontrol.vue';
